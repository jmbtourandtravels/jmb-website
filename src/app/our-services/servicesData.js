...
export const servicesData = {
  "corporate-cab-services": {
    ...
    detailedDescription: `
      ...
      <p>• Experienced professional drivers<br/>
         ...
         • 24/7 corporate support<br/>
         • Flexible billing and payment options<br/>
         • Multiple vehicle types for different needs</p>
    `,
    icon: "briefcase",
    image: "/assets/services/corporate.png",
    features: [
      "Professional Business Class Vehicles",
  ...
  "airport-cab-services": {
    ...
    detailedDescription: `
      ...
      <p>• Flight tracking for on-time service<br/>
         • Meet & greet available<br/>
         • Ample luggage space<br/>
         • Transparent fixed pricing<br/>
         • 24/7 airport service</p>

      <h3>Covered Airports</h3>
      <p>We cover Devi Ahilya Bai Holkar Airport (Indore), Raja Bhoj Airport (Bhopal), and other major airports.</p>
    `,
    icon: "plane",
  ...
  "indore-to-ujjain": {
    ...
    detailedDescription: `
      ...
      <h3>Route Details</h3>
      <p>• Distance: ~55 km<br/>
         • Travel Time: 1.5-2 hours<br/>
         • Route: NH52<br/>
         • Popular Spots: Mahakaleshwar Temple, Ram Ghat, Kal Bhairav Temple</p>

      <h3>Service Highlights</h3>
      <p>• Multiple vehicle options<br/>
         • Experienced drivers<br/>
         • 24/7 service availability<br/>
         • Transparent pricing<br/>
         • Temple tour packages available</p>
    `,
    icon: "car",
  ...
  "ujjain-to-indore": {
    ...
    detailedDescription: `
      ...
      <p>• Flexible pickup points in Ujjain<br/>
         • Comfortable vehicles<br/>
         • Experienced drivers<br/>
         • 24/7 booking availability<br/>
         • Easy online and phone booking</p>

      <h3>Booking Options</h3>
      <p>Book via our website, Whatsapp or call on our customer service. Pre-book during onward travel for convenience.</p>
    `,
    icon: "car",
    image: "/assets/services/ujjaintoindore.png",
    features: [
      "Multiple Ujjain Pickup Points",
      "Flexible Return Timing",
      "Easy Booking Methods",
      "Comfortable Return Travel",
      "24/7 Service Availability"
    ],
    seo: {
  ...
  "indore-to-omkareshwar": {
    ...
    detailedDescription: `
      ...
      <p>• Distance: ~77 km<br/>
         • Travel Time: 2-2.5 hours<br/>
         • Route: Via Barwaha and Mortakka<br/>
         • Key Site: Omkareshwar Jyotirlinga Temple</p>

      <h3>Pilgrimage Services</h3>
      <p>• Early morning departures<br/>
         • Temple timing knowledge<br/>
         • Comfortable vehicles<br/>
         • Waiting time included for darshan</p>
    `,
    icon: "umbrella-beach",
    image: "/assets/services/indoretoomkareshwar.png",
    features: [
      "Special Pilgrimage Packages",
      "Early Morning Departures",
      "Temple Timing Knowledge",
      "Comfortable Spiritual Journey",
  ...
  "omkareshwar-to-indore": {
   ...
   shortDescription: "Seamless cab and taxi travel from Omkareshwar to Indore",
    ...
    detailedDescription: `
      ...
      <h3>Service Features</h3>
      <p>• Flexible timing<br/>
         • Comfortable vehicles<br/>
         • Experienced drivers<br/>
         • 24/7 support<br/>
         • Multiple pickup points</p>

      <h3>Booking Convenience</h3>
      <p>Book through mobile app, website, or customer service. Pre-book for seamless travel.</p>
    `,
    icon: "car",
    image: "/assets/services/omkareshwartoindore.png",
    features: [
      "Flexible Return Timing",
  ...
  "indore-to-maheshwar": {
    ...
    detailedDescription: `
      ...
      <p>• Distance: ~91 km<br/>
         • Travel Time: 2-2.5 hours<br/>
         • Route: NH47 and State Highway<br/>
         • Key Attractions: Maheshwar Fort, Ahilya Fort, Narmada Ghats</p>

      <h3>Service Highlights</h3>
      <p>• Scenic routes with comfortable vehicles<br/>
         • Knowledgeable drivers<br/>
         • Full-day trip options<br/>
         • Photography stops included<br/>
         • Flexible scheduling</p>
    `,
    icon: "hotel",
    image: "/assets/services/indoretomaheshwar.png",
    features: [
      "Scenic Route Travel",
  ...
  "indore-to-mandav": {
    ...
    detailedDescription: `
      ...
      <p>• Distance: ~99 km<br/>
         • Travel Time: 2.5-3 hours<br/>
         • Route: NH47 and State Highway<br/>
         • Key Attractions: Mandav Fort, Jahaz Mahal, Hindola Mahal</p>

      <h3>Service Highlights</h3>
      <p>• Full-day heritage tours<br/>
         • Experienced drivers<br/>
         • Comfortable vehicles<br/>
         • Customizable itinerary<br/>
         • Photography-friendly stops</p>
    `,
    icon: "user-friends",
  ...
  "indore-to-mandleshwar": {
    ...
    detailedDescription: `
      ...
      <p>• Distance: ~87 km<br/>
         • Travel Time: 2-2.5 hours<br/>
         • Route: Via Dhamnod and State Highway<br/>
         • Key Attractions: Narmada Ghats, Ancient Temples</p>

      <h3>Service Highlights</h3>
      <p>• Comfortable family-friendly vehicles<br/>
         • Local attraction guidance<br/>
         • Flexible timing<br/>
         • Affordable and transparent pricing<br/>
         • Expert drivers for smooth journey</p>
    `,
    icon: "umbrella-beach",
    image: "/assets/services/indoretomandleshwar.png",
    features: [
  ...
  "indore-to-bhopal": {
    ...
    detailedDescription: `
      ...
      <h3>Route Information</h3>
      <p>• Distance: ~190 km<br/>
         • Travel Time: 3.5-4 hours<br/>
         • Route: NH52<br/>
         • Key Points: Bhopal city center, airports, railway stations</p>

      <h3>Service Highlights</h3>
      <p>• Multiple vehicle options<br/>
         • Experienced highway drivers<br/>
         • Comfortable stops enroute<br/>
         • 24/7 booking support<br/>
         • Corporate and individual travel options</p>
    `,
    icon: "car",
  ...
  "bhopal-to-indore": {
    ...
    detailedDescription: `
      ...
      <h3>Service Features</h3>
      <p>• Flexible pickup points<br/>
         • Experienced drivers<br/>
         • Comfortable vehicles<br/>
         • 24/7 booking support<br/>
         • On-time arrivals guaranteed</p>

      <h3>Booking Options</h3>
      <p>Book through our website, or whatsapp for a hassle-free return journey.</p>
    `,
    icon: "car",
  ...
  "mandav-to-indore": {
    ...
    detailedDescription: `
      ...
      <h3>Service Highlights</h3>
      <p>• Flexible departure timings<br/>
         • Comfortable vehicles<br/>
         • Knowledgeable drivers<br/>
         • Safe night travel<br/>
         • Multiple pickup points</p>

      <h3>Booking Options</h3>
      <p>Book via website, Whatsapp or call on our customer service for hassle-free travel back to Indore.</p>
    `,
    icon: "user-friends",
    image: "/assets/services/mandavtoindore.png",
    features: [
  ...
  detailedDescription: `
    ...
    <h3>Service Highlights</h3>
    <p>• On-time pickup from your location<br/>
       • Comfortable and air-conditioned cars<br/>
       • Professional and experienced drivers<br/>
       • Affordable and transparent pricing<br/>
       • 24/7 booking availability</p>

    <h3>Booking Options</h3>
    <p>Book your Indore to Nagda cab through our website, WhatsApp, or call our customer support for instant confirmation and reliable travel assistance.</p>
  `,
  icon: "user-friends",
  image: "/assets/services/indoretonagda.png",
  features: [
    "On-Time Pickup",
    "Comfortable Vehicles",
    "Affordable Pricing",
...
export const allServices = Object.values(servicesData).map(service => ({
  id: service.id,
  title: service.title,
