...
const SERVICE_DROPDOWN_LINKS = [
  { name: "All Services", href: "/our-services" },
  {
    ...
    href: "/our-services/corporate-cab-services",
  },
  ...
  { name: "Indore to Ujjain", href: "/our-services/indore-to-ujjain" },
  {
    ...
    href: "/our-services/indore-to-omkareshwar",
  },
  ...
  {
    name: "Omkareshwar to Indore",
    href: "/our-services/omkareshwar-to-indore",
  },
...
const ContactCTA = () => (
  <div className="flex items-center justify-end h-full px-4 sm:px-6 lg:px-8 w-full lg:w-auto">
    ...
    <a
      ...
      className="flex items-center space-x-2 text-white transition-colors hover:text-[#FFD700]"
    >
      <svg
      ...
      <span className="text-lg font-extrabold tracking-tight hidden lg:inline-block">
        +91 77720 75970
      </span>
      <span className="text-lg font-extrabold tracking-tight lg:hidden">
        +91 77720 75970
      </span>
    </a>
...
const Logo = () => (
  <div className="flex items-center flex-shrink-0 ml-2 lg:ml-0">
    <Link href="/" className="flex items-center">
      ...
      <div className="relative w-18 h-18 sm:w-14 sm:h-14 lg:w-25 lg:h-25">
        <Image
          src="/assets/logoNew.png" // Replace with your logo path
...
const MobileLogo = () => (
  <div className="flex items-center flex-shrink-0 ml-2">
    <Link href="/" className="flex items-center">
      <div className="relative w-25 h-25 sm:w-20 sm:h-20">
        <Image
          src="/assets/logoNew.png" // Replace with your logo path
  ...
  return (
    <nav className="shadow-xl sticky top-0 z-50 font-sans bg-white">
      ...
      <div className="flex flex-col lg:flex-row w-full min-h-20">
          ...
          <div className="hidden lg:flex items-center space-x-4 xl:space-x-6 text-sm font-medium h-full">
            {NAV_LINKS.map((link) => (
              <div
                ...
                onMouseEnter={() =>
                  link.dropdown && setIsServicesDropdownOpen(true)
                }
                onMouseLeave={() =>
                  link.dropdown && setIsServicesDropdownOpen(false)
                }
              >
                <a
                  href={link.href}
                ...
                >
                  ...
                  {link.dropdown && (
                    <span className="ml-1">
                      <svg
                        className={`w-3 h-3 transition-transform duration-200 ${isServicesDropdownOpen ? "transform rotate-180" : ""}`}
                        fill="none"
                        stroke="currentColor"
                        viewBox="0 0 24 24"
                      >
                ...
                {link.dropdown && isServicesDropdownOpen && (
                  <div className="absolute top-full left-0 mt-0 w-56 xl:w-64 bg-white border border-gray-200 shadow-xl rounded-lg overflow-hidden z-20">
                    <div className="p-2">
        ...
        <div className="hidden lg:flex lg:w-1/4 h-20" style={darkSectionStyle}>
          <ContactCTA />
        </div>
      </div>
      ...
      >
        ...
        <nav className="p-4 flex flex-col space-y-2">
          ...
          <div
            className="p-4 mt-6 border-t pb-8 border-gray-100 rounded-xl"
